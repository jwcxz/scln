...
class Bootloader:
    ...
    def __init__(self, port='/dev/ttyS0'):
        ...
        self.cxn = serial.Serial(port, 9600, parity=serial.PARITY_EVEN);
    ...
    def disp(self):
        self.write(self.CMDS['SYNC']);
        self.write(self.CMDS['DISP']);
        
    def eset(self, addr, data):
        self.write(self.CMDS['SYNC']);
        self.write(self.CMDS['ESET']);
        self.write(chr(addr));
        self.write(chr(data));
        
    def eget(self, addr):
        self.write(self.CMDS['SYNC']);
        self.write(self.CMDS['EGET']);
        self.write(chr(addr));
